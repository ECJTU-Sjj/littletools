...
def job():
    product = "SCRM/企微助手"
    #conn = pymysql.connect(host="rm-m5eakra35e59hz3if8o.mysql.rds.aliyuncs.com", user="zentao_wangle",password="Ae26e6fc", database="zentao_pm", charset="utf8"
    ...
    zentao_pm.zt_bug.severity,
     ...
     and (zentao_pm.zt_bug.status ="active" or (zentao_pm.zt_bug.status ="resolved" and zt_bug.resolution not in('bydesign','designdefect','duplicate','notbug','nobug','storybug')))
